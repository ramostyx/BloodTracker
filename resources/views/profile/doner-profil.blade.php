<x-app-layout>
    <div class="grid grid-cols-3 gap-2 px-56 ">
        <div class="h-full pb-24 bg-white col-span-1 relative flex flex-col justify-start items-center p-2">
            ...
            <div class="w-full flex font-bold text-[15px] justify-start py-1 px-3 items-center">
                ...
                <p>{{\Illuminate\Support\Facades\Auth::user()->saveCount()}}</p>
            </div>

            <div class="w-full px-3 py-1 flex font-bold text-left text-[15px] justify-start items-start">
                <p> Donations: </p>
                <p>{{\Illuminate\Support\Facades\Auth::user()->donor->donations->count()}}</p>
            </div>
        </div>
...
" id="pills-security-tab3" data-bs-toggle="pill" data-bs-target="#pills-security" role="tab"
            ...
            <div class="tab-content" id="pills-tabContent3">
                <div class="tab-pane fade show active" id="pills-personal-info" role="tabpanel"
                    ...
                    <form class="m-1" method="POST" action="{{route('profile.update',$user->id)}}">
                        @csrf
                        @method('PUT')
                        <!-- Name -->
                        <div class="my-2 ">
                        ...
                        <div class="w-full flex justify-between items-center mt-4">
                            <!-- BloodType -->
                            <div>
                                <div class="bg-[#2CA4C6] rounded-full px-4 py-1 ">
                                    <p class="text-white  "> Blood Type: {{$user->donor->bloodType}}</p>
                                </div>
                            </div>
